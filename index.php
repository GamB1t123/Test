...
echo '17-й символ из фразы: ', ord($str[17]) . '<br>';
echo 'Сделать заглавной первую букву во всех словах фразы: ', $str1 . '<br>';
echo 'Длина строки: ', strlen($str) . '<hr>';
